...
- ecc-bundle-addition: Adds or updates the stoictradingAI ECC bundle, including configuration, documentation, skills, rules, research playbooks, and agent definitions.
- team-config-update: Updates the team configuration for stoictradingAI.
