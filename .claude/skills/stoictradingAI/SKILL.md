...
Adds or updates a set of configuration, documentation, and skill files as part of the stoictradingAI ECC bundle.

**Frequency**: ~4 times per month

**Steps**:
1. Add or update .claude/commands/team-config-update.md
